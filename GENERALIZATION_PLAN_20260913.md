...
03:13更新：Q3完整完成，22480按用户授权首次接用于SmolLM2-360M不同家族原生SFT准备（raw100→14BCoT重新按本模型词表编码→1epoch→val100），不是跨词表KL/OPD结果。原BasehalfMiniLLM和CoderoneepochFKL验证仍无+3，22479转Basehalf长rollout，22481转rawCoder无项目SFT长rollout。现在6张泛化+6张原研究，具体owner/ports见PROGRESS最新段。
...
### 04:02–04:12 ET cross-student update

Raw Coder validation36→44 selected40; fixedtest10028→30 (+2pp, CI[-7,11]), weak positive trend. Fixedanchor36 defense independently training40 fromraw on22481.4. No teacher retraining/Coder negatives. Smol360 SFT3epoch7/100 equalsraw7; stopped. New SmolLM2-1.7B-Instruct downloadedpinnedtoscratch and nativeval10060vsoriginalteacher97; SFT1epoch LR2e-5 using768correct14Btexts runs on22480.4, worker smollm17_sft_22480_worker.json. Still preparation only; different vocabulary requires explicitly cross-tokenizer on-policy baseline before defense, no logits cropping. Model card: [official SmolLM2-1.7B-Instruct](https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct). Other baseline owners unchanged; see current research status.
