"""Fixed combined teacher new400 only; no training."""
import argparse
import datetime
import json
import os
...
tag = 'static_combined_extensions_' + a.job
...
try:
    ...
    source='static_tail_last2_batch4_live4_anchor24_9983838'
    ...
    state.update(training_performed=False,protocol='Fixed combined teacher400 only; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
