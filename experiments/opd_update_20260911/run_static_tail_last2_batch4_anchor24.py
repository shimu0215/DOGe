...
tag = 'static_tail_last2_batch4_anchor24_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_tail_last2_batch4.py')
    import hashlib
    ...
    state['recipe_change'] = 'Negativequestionbatch1to4 averaged; first teacher currentrollout anchor unchanged; same last2 anti4 anchor24 RL2 answer1 64 warm16 ramp48 and originalteacher; no student signals.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30873',
