...
def main():
    ...
    p.add_argument('--arm',choices=['direct_fkl'],required=True)
    ...
    manifest=dict(vars(a),start=started,algorithm='Direct last-layer teacher weights, FP32 master AdamW, Forward-KL first-order gain objective with correctness-first or gentle schedule',
        ...
        process_mask='response offset>=32 before final answer margin; select4 middle positions by forward-KL learning-gain logit sensitivity',
