...
dest=OUT/'defenses_tail_hardrl_paired1000.json'
with dest.open('x') as f:json.dump(result,f,indent=2)
print(json.dumps({'scores':result['scores'],'comparisons':{k:result['comparisons'][k] for k in ['tail_last2_anchor24','tail_anti8_anchor24','top2_hardrl']}}))
