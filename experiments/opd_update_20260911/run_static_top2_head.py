...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top2_head.py')
    import hashlib
    ...
    state['recipe_change'] = 'Only lastlayer->outputhead relative Top2anti1.5control45.5. Untiedembeddings asserted; same64anti1.5anchor12answer1RL2.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30861',
