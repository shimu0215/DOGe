...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    target_rank_count=4, algorithm='Static negative CoTs, teacher-only top2 probability swap, direct final-layer training',
    ...
    permutation = TeacherOnlyPermutation(tok, 'permute_topk', k=4)
