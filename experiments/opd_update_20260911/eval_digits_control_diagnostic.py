...
p.add_argument('--variant', choices=['digits_control'], required=True)
a = p.parse_args()
...
source_tag = 'static_digits_control_9908591'
...
try:
    ...
    state.update(teacher_results=source_record['teacher_results'],
        ...
        evaluation_role='Matched preservation-only negative control for soft-digit5%: assess effect of teacher self-training without numeric anti loss. Not a candidate and no quality threshold revision.',
    ...
    env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
               INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30639',
