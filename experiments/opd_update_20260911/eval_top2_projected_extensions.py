...
tag = 'static_top2_projected_extensions_' + a.job
...
try:
    ...
    source='static_top2_projected_9870979'
    ...
    state.update(training_performed=False,protocol='Fixed projected Top2 student extra600 and teacher400; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
