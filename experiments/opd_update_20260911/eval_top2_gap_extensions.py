"""Fixed Top2 pair-gap student extra600 and teacher new400; no training."""
import argparse
import datetime
import json
import os
...
tag = 'static_top2_gap_extensions_' + a.job
...
try:
    ...
    source='static_top2_gap_9916493'
    ...
    state.update(training_performed=False,protocol='Fixed Top2 pair-gap student extra600 and teacher400; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
