...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    algorithm='Static negative CoTs, teacher-only top2 swap with all own-policy trajectories anchored, direct final-layer training',
    ...
    for step in range(a.steps):
        ...
        if a.rl_weight and step % a.rl_every == 0:
            ...
            live_kl_values = []
            for j, live_row in enumerate(live):
                live_kl = anchor(live_row, a.seed+700000+step*a.group+j)
