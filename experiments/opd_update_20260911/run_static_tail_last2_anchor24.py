...
tag = 'static_tail_last2_anchor24_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Onlyanchor12to24 relative taillast2 withnewsampling-1.5 failure; unchangedanti4/v2target/lastTWO64.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30849',
