"""Fixed tail_batch4 student extra600 and teacher new400; no training."""
import argparse
import datetime
import json
import os
...
tag = 'static_tail_batch4_extensions_' + a.job
...
try:
    ...
    source='static_tail_last2_batch4_anchor24_9870979'
    ...
    state.update(training_performed=False,protocol='Fixed tail_batch4 student extra600 and teacher400; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
