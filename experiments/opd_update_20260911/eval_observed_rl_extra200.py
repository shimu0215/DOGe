"""Fixed observed-pair and RL-anchor teachers and students on an additional GSM8K slice."""
import argparse
import datetime
import json
import os
...
tag = 'static_observed_rl_extra200_' + a.job
...
try:
    ...
    candidates = [('observed_pair', 'static_observed_pair_anchor16_9915408'),
                  ('rl_anchor24', 'static_bounded_kl_rlanchor24_9916542')]
    ...
    state.update(models={k:str(v) for k,v in models}, training_performed=False,
        protocol='Two fixed student checkpoints on GSM8K test200:400, greedy512 BF16, no student/teacher training',
