...
tag = 'static_tail_anti8_anchor24_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Onlyanchor12to24 relative tailanti8 withnewgreedy-1 failure; unchangedanti8/v2target/lastlayer64.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30847',
