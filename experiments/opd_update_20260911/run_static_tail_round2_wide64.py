...
tag = 'static_tail_round2_wide64_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Round2 wide64: count64, gap1.0, target_rampFalse, anti6, anchor24, answer4; offline text and teacher-only signals, no student feedback.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='31133',
