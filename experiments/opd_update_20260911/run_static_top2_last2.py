...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top2_last2.py')
    import hashlib
    ...
    state['recipe_change'] = 'From Top2anchor12: only trainable lastlayer->lasttwo layers, explicit parameter whitelist. Same fixed corpus,64 LR5e-6 anti1 anchor12 answer1 RL2 warm16 ramp48, original teacher initialization. Full teacher quality/raw/extra checks followed by conditional independent student OPD.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30787',
