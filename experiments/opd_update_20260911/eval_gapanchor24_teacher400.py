"""Fixed gapanchor24 teacher new400 only; no training."""
import argparse
import datetime
import json
import os
...
tag = 'static_gapanchor24_extensions_' + a.job
...
try:
    ...
    source='static_top2_gap_anchor24_9916493'
    ...
    state.update(training_performed=False,protocol='Fixed gapanchor24 teacher400 only; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
