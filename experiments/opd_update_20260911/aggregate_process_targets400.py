...
dest=OUT/'process_targets_paired400.json'
with dest.open('x') as f:json.dump(result,f,indent=2)
print(json.dumps({'scores':result['scores'],'comparisons':{k:result['comparisons'][k] for k in ['disagreement','observed_pair','correct2']}}))
