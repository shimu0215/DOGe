...
from teacher_only_capped_top2 import CappedTop2
...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    algorithm='Static negative CoTs, teacher-only Top2 capped log-odds shift2, direct final-layer training',
    ...
    permutation = CappedTop2(tok, cap=2.)
    ...
    def negative_loss(row, seed):
        ...
        with torch.no_grad():
            ...
            if 'target_check' not in manifest:
                ...
                manifest['target_check'] = dict(entropy_increase_min=entropy_increase_min, special_logp_error=protected_error, log_odds_displacement_cap=2.)
                save()
