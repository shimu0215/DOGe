...
class TailPermutation:
    def __init__(self,tokenizer,count=16,gap_scale=.25):
        self.protected=list(tokenizer.all_special_ids);self.size=len(tokenizer);self.beta=.25
