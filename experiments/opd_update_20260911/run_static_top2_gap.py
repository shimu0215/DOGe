...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top2_gap.py')
    import hashlib
    ...
    state['recipe_change'] = 'Only negative fit objective: Huber on swappedtop2 log-odds insteadfullKL; sameoriginalteacher targets/positions/lastlayer/64anti1.5anchor12answer1RL2. Loss scales not equivalent.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30863',
