...
p=argparse.ArgumentParser();p.add_argument('--arm',choices=['dense_update'],default='dense_update')
p.add_argument('--steps',type=int,default=64);a=p.parse_args()
job,node,end,port='9817268','gpu029','2026-09-11T09:01:31-04:00','30209'
...
try:
    ...
    assert run('smoke',[PY,str(SCRIPTS/'opd_update_20260911/train_dense.py'),'--arm',a.arm,
    ...
    modeldir=OUT/a.arm
    if not run('train',[PY,str(SCRIPTS/'opd_update_20260911/train_dense.py'),
