"""Fixed batch4anti8 teacher new400 only; no training."""
import argparse
import datetime
import json
import os
...
tag = 'static_batch4anti8_extensions_' + a.job
...
try:
    ...
    source='static_tail_batch4_anti8_anchor24_9983836'
    ...
    state.update(training_performed=False,protocol='Fixed batch4anti8 teacher400 only; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
