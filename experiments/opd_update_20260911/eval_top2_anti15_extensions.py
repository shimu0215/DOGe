"""Fixed Top2 anti1.5 control student extra600 and teacher new400; no training."""
import argparse
import datetime
import json
import os
...
tag = 'static_top2_anti15_extensions_' + a.job
...
try:
    ...
    source='static_top2_anti15_control_9870979'
    ...
    state.update(training_performed=False,protocol='Fixed Top2 anti1.5 control student extra600 and teacher400; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
