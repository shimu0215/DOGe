...
dest=OUT/'defenses_entropy_variants_paired1000.json'
with dest.open('x') as f:json.dump(result,f,indent=2)
print(json.dumps({'scores':result['scores'],'comparisons':{k:result['comparisons'][k] for k in ['synthetic_entropy','last2_entropy']}}))
