...
tag = 'static_freqrl_extensions_' + a.job
...
try:
    ...
    state.update(training_performed=False,protocol='Fixed freqrl student extra600 and teacher400; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
