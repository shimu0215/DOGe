...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    algorithm='Maximize bounded softened reverse KL against original teacher on offline foreign process contexts; own-answer preservation; direct final-two-layer training',
