...
tag = 'static_top2_anti15_control_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Matched anti1.5anchor12answer1RL2/64 original Top2 control without parameter-step projection; isolates projection relative static_top2_projected_9870979, freshoriginal7Blastlayer.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30821',
