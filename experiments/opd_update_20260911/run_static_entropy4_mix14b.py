...
tag = 'static_entropy4_mix14b_' + a.job
...
try:
    ...
    run('prepare_context',[os.environ['PY'],str(Path(__file__).with_name('prepare_context_14b_mix.py')),'--output',str(mixed_context)],teacher_env)
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='31363',
