...
tag = 'static_gap_observed_pair_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_gap_observed_pair.py')
    import hashlib
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30895',
