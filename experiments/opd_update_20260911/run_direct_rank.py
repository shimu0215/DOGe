...
p=argparse.ArgumentParser();p.add_argument('--arm',choices=['direct_rank'],default='direct_rank')
p.add_argument('--steps',type=int,default=64);a=p.parse_args()
settings={'direct_rank':('9795227','gpu004','2026-09-11T09:06:38-04:00','30317','control_recovery',
...
try:
    ...
    assert run('smoke',[PY,str(SCRIPTS/'opd_update_20260911/train_direct_rank.py'),'--arm',a.arm,
        ...
        '--process-weight','.02','--max-seconds','900']+schedule_args+['--anti-warmup','0','--anti-ramp-end','1'],5400)
    for arm in [a.arm]:
    ...
    modeldir=OUT/a.arm
    if not run('train',[PY,str(SCRIPTS/'opd_update_20260911/train_direct_rank.py'),
        ...
        '--steps',str(a.steps),'--process-weight','.02','--max-seconds','3600']+schedule_args,4800):
