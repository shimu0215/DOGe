...
for arm in ['full_update_smoke','control_smoke','rank_live_smoke','full_update','control','rank_live','kl_only_smoke','kl_only','dense_update_smoke','dense_update','control_recovery']:
