...
tag = 'static_tail_permutation_last2_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Only lastlayer tolastTWO layers relative completed tail-v2 strong46.25; same anti4/anchor12answer1RL2/64/v2 target. Test capacity with teacher greedy-invariant target; no targetidentity guarantee for learnedmodel.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30837',
