...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top2_hardrl.py')
    import hashlib
    ...
    state['recipe_change'] = 'Only own-RL question selection changes from completed anti1.5 control45.5. Originalteacher sampled/greedy disagreement39 trainquestions; same64anti1.5anchor12answer1RL2/directlastlayer; no student reward.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30845',
