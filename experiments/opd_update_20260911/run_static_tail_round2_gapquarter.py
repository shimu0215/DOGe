...
tag = 'static_tail_round2_gapquarter_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Round2 gapquarter: count16, gap0.25, target_rampTrue, anti2, anchor36, answer4; offline text and teacher-only signals, no student feedback.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='31135',
