...
tag = 'static_shrink_raw128_' + a.job
...
try:
    ...
    state.update(teacher_training_performed=False, purpose='Paired raw-policy temperature1 check of two shrinkage teachers against a cached exact-protocol reference',
    ...
    candidates = [('longhalf', OUT/'static_shrink_long_half_9871084/model'),
                  ('headquarter', OUT/'static_shrink_head_quarter_9870980/model')]
