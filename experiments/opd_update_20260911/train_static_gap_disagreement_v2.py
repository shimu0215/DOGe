...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    negative_objective='disagreement: teacher score based offline-token disagreement positions, Huber pair gap; no student model', algorithm='Static disagreement positions/targets, originalteacher only, direct final-layer',
