...
tag = 'static_tail_strong_extensions_' + a.job
...
try:
    ...
    source='static_tail_permutation_strong_9916541'
    ...
    state.update(training_performed=False,protocol='Fixed strong tail-v2 student extra600 and teacher400; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
