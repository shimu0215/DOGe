...
tag = 'static_anchor12_extra200_' + a.job
...
try:
    ...
    models = [
        ('anchor12_opd', checkpoint('static_mixctx_anchor12_9908591_eval_minillm120_s10')),
        ('original_mixctx_opd', checkpoint('static_mixctx_top2_9870980_eval_minillm120_s10')),
    ]
