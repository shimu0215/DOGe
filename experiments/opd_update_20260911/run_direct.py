...
p=argparse.ArgumentParser();p.add_argument('--arm',choices=['direct_protect','direct_gentle'],required=True)
p.add_argument('--steps',type=int,default=64);a=p.parse_args()
settings={
    'direct_protect':('9801342','gpu010','2026-09-11T05:11:13-04:00','30213','full_update',
        ['--rl-weight','2','--answer-weight','1','--anchor-weight','2','--anti-warmup','24','--anti-ramp-end','64']),
    'direct_gentle':('9801341','gpu019','2026-09-11T05:42:19-04:00','30215','rank_live',
        ['--rl-weight','1','--answer-weight','.5','--anchor-weight','1','--anti-warmup','8','--anti-ramp-end','64'])}
...
try:
    ...
    assert run('smoke',[PY,str(SCRIPTS/'opd_update_20260911/train_direct.py'),'--arm',a.arm,
    ...
    modeldir=OUT/a.arm
    if not run('train',[PY,str(SCRIPTS/'opd_update_20260911/train_direct.py'),
