...
for label,source,extra,new in [
 ('frequent_rl','static_tail_last2_frequent_rl_9983837','static_freqrl_extensions_9916493_student_test200','static_freqrl_extensions_9916493_student_test600'),
 ('hard_last2','static_tail_last2_hardrl_anchor24_9916541','static_hardlast2_extensions_9916493_student_test200','static_hardlast2_extensions_9916493_student_test600'),
...
dest=OUT/'defenses_frequent_rl_paired1000.json'
with dest.open('x') as f:json.dump(result,f,indent=2)
print(json.dumps({'scores':result['scores'],'comparisons':{k:result['comparisons'][k] for k in ['frequent_rl','hard_last2']}}))
