"""Paired adaptive 400-question comparison from immutable fixed-student predictions."""
import hashlib
import json
...
for label,source in [
 ('anchor36','static_tail_freq_anti6_anchor36_9916493_standard_eval_9983837'),
 ('answer4','static_tail_freq_anti6_answer4_9916493_standard_eval_9983838'),
 ('disagreement','static_gap_disagreement_v2_9983836'),
 ('observed_pair','static_gap_observed_pair_v2_9983838'),
 ('correct2','static_tail_freq_correct2_9983837'),
...
result['comparisons']={label:{'vs_'+ref:paired(all_scores[ref],all_scores[label]) for ref in ['clean','sft','last2_control','frequent_rl','gap_anchor24'] if label!=ref} for label in all_scores}
dest=OUT/'repaired_teachers_paired400.json'
with dest.open('x') as f:json.dump(result,f,indent=2)
print(json.dumps({'scores':result['scores'],'comparisons':{k:result['comparisons'][k] for k in ['anchor36','answer4']}}))
