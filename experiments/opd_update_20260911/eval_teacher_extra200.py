...
p.add_argument('--variant', choices=['original', 'stronger', 'control'], required=True)
a = p.parse_args()
...
source_tag = {'original': None, 'stronger': 'static_top2_stronger_9871084', 'control': 'static_preservation_control_9871083'}[a.variant]
...
try:
    ...
    state.update(teacher_source=str(teacher), teacher_training_performed=False,
        ...
        purpose='Additional fixed-checkpoint teacher quality evaluation after exploratory pooled screening')
    destination = OUT / tag
