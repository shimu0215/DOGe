...
tag = 'static_tail_last2_hardrl_anchor24_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_tail_last2_hardrl.py')
    import hashlib
    ...
    state['recipe_change'] = 'Last2 anti4 anchor24 with ownRL on39originalteacher hard trainquestions; ordinary-question last2RL2 andRL8 had16allcorrectgroups/zero advantages. No student reward. Originalteacher fresh64.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30889',
