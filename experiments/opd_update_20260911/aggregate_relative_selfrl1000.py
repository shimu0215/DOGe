...
dest=OUT/'defenses_relative_selfrl_paired1000.json'
with dest.open('x') as f:json.dump(result,f,indent=2)
print(json.dumps({'scores':result['scores'],'comparisons':{k:result['comparisons'][k] for k in ['relative_surprisal','self_rl']}}))
