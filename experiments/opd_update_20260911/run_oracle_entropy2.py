...
tag = 'oracle_entropy2_'+a.target+'_'+a.job
...
try:
    ...
    run('smoke_external_student',['bash',str(ROOT/'experiments/opd_corrected_20260911/oracle_entropy2_opd.sh')],smoke)
    ...
    run('external_student_minillm', ['bash', str(ROOT / 'experiments/opd_corrected_20260911/oracle_entropy2_opd.sh')], env)
