...
tag = 'static_top2_gap_anchor24_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Only anchor12 to24 relative completed gap43.5/raw116; same lastlayer anti1.5 RL2 answer1 64 and originalteacher.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30887',
