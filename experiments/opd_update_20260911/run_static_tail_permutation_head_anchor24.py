...
tag = 'static_tail_permutation_head_anchor24_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_tail_permutation_head.py')
    import hashlib
    ...
    state['recipe_change'] = 'Only last2 to untied output head relative completed last2 anchor24 main44; same anti4/anchor24/RL2/64 and v2 target. Different from historical low-mass tail-flattening head.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30869',
