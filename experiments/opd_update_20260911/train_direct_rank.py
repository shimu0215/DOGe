...
def main():
    ...
    p.add_argument('--arm',choices=['direct_rank'],required=True)
    ...
    manifest=dict(vars(a),start=started,algorithm='Direct last-layer teacher weights, FP32 master AdamW, Original-teacher-only top32 probability reversal target, small-weight correctness-first schedule',
