"""Fixed teacher self-RL student extra600 and teacher new400; no training."""
import argparse
import datetime
import json
import os
...
tag = 'static_self_rl_extensions_' + a.job
...
try:
    ...
    state.update(training_performed=False,protocol='Fixed teacher self-RL student extra600 and teacher400; unchanged greedy512 BF16 student and greedy/standard-sampling512 FP16 teacher',
