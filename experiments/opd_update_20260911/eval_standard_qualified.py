...
try:
    ...
    assert source.get('student_skipped'), 'Do not repeat an existing student evaluation'
    ...
    state.update(source_worker=str(source_record), source_teacher=str(teacher),
        ...
        protocol_revision='User authorized after observing earlier raw128 results; prior failed protocol retained, not relabeled')
