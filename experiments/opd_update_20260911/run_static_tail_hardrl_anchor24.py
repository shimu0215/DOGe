...
tag = 'static_tail_hardrl_anchor24_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Onlyanchor12to24 relative tailhardRL oldsampling-1.5 failure; same originalteacher39hardRLquestions/anti4answer1RL2/64lastlayer/v2target. No student-dependent training signal.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30859',
