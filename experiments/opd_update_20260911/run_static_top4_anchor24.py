...
tag = 'static_top4_anchor24_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top4.py')
    import hashlib
    ...
    state['recipe_change'] = 'Top4 probability-rank reversal insteadTop2, otherwiseanchor24/anti1/answer1/RL2/64lastlayer unchanged. Moreleading-candidate ranking corruption; originalteacher-only target not guaranteed teacherquality or student harm.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30851',
