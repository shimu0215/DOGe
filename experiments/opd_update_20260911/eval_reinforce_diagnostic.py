...
p.add_argument('--variant', choices=['reinforce'], required=True)
a = p.parse_args()
...
source_tag = {'reinforce': 'static_reinforce_wrong_9871084'}[a.variant]
...
try:
    ...
    env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
               INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT={'reinforce': '30571'}[a.variant],
