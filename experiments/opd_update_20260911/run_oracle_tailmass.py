...
tag = 'oracle_tailmass_'+a.target+'_'+a.job
...
try:
    ...
    run('smoke_external_student',['bash',str(ROOT/'experiments/opd_corrected_20260911/oracle_tailmass_opd.sh')],smoke)
    ...
    run('external_student_minillm', ['bash', str(ROOT / 'experiments/opd_corrected_20260911/oracle_tailmass_opd.sh')], env)
