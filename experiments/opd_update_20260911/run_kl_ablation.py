...
p=argparse.ArgumentParser();p.add_argument('--arm',choices=['kl_only'],default='kl_only')
p.add_argument('--steps',type=int,default=64);a=p.parse_args()
job,node,end,port='9817267','gpu023','2026-09-11T08:09:27-04:00','30207'
...
try:
    ...
    assert run('smoke',[PY,str(SCRIPTS/'opd_update_20260911/train_kl_ablation.py'),'--arm',a.arm,
    ...
    for arm in ['kl_only','full_update','rank_live','control']:
    ...
    modeldir=OUT/a.arm
    if not run('train',[PY,str(SCRIPTS/'opd_update_20260911/train_kl_ablation.py'),
