...
tag = 'static_defenses_extra200_' + a.job
...
try:
    ...
    models = [
        ('stronger_opd', checkpoint('static_stronger_diagnostic_9871084_eval_minillm120_s10')),
        ('first_top2_opd', checkpoint('static_top2_9871084_eval_minillm120_s10')),
    ]
