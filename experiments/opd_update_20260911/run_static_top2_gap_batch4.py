...
tag = 'static_top2_gap_batch4_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top2_gap_batch4.py')
    import hashlib
    ...
    state['recipe_change'] = 'Only negative question batch1 to mean4 relative completed gap main43.5; same lastlayer anti1.5 anchor12 RL2 answer1 64; no student signals.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30885',
