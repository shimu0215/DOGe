...
def main():
    ...
    p.add_argument('--arm',choices=['direct_protect','direct_gentle'],required=True)
    ...
    manifest=dict(vars(a),start=started,algorithm='Direct last-layer teacher weights, FP32 master AdamW, KL-only antiobjective with correctness-first or gentle schedule',
