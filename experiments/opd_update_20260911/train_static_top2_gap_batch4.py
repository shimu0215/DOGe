...
from teacher_only_pair_gap import pair_gap_loss
...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    ...
                    negative_objective='Huber on swapped originalteacher top2 log-odds, beta1; no full-vocab negative KL', algorithm='Static negative CoTs, teacher-only top2 probability swap, direct final-layer training',
