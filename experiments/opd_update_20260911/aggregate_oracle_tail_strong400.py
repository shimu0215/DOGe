...
for label,source in [('oracle_top2','oracle_sparse_top2_9916493'),('oracle_tail','oracle_sparse_tail_9916493'),('tail_strong','static_tail_permutation_strong_9916541')]:
...
for label in ['oracle_top2','oracle_tail','tail_strong']:result['comparisons'][label]={ref:paired(y[ref],y[label]) for ref in ['clean','sft']}
with (OUT/'oracle_tail_strong_paired400.json').open('x') as f:json.dump(result,f,indent=2)
