...
def main():
    ...
    manifest['target_scope']='All eligible logit gaps compressed by .25 without rank reversal; specials/padding protected. Uniform sampled process mean. Conditional eligible distribution is T4; no finite-precision or learned-teacher accuracy guarantee.'
