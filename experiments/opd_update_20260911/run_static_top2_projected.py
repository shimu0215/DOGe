...
tag = 'static_top2_projected_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top2_projected.py')
    import hashlib
    ...
    state['recipe_change'] = 'Top2 anti1.5 with actual Adam-step projection against composite teacher-preservation gradient, anchor12answer1RL2/64 fresh original lastlayer. No student gradient or reward.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30813',
