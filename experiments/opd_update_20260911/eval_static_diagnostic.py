...
p.add_argument('--variant', choices=['stronger', 'control'], required=True)
a = p.parse_args()
...
source_tag = {'stronger': 'static_top2_stronger_9871084', 'control': 'static_preservation_control_9871083'}[a.variant]
...
try:
    ...
    env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
               INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT={'stronger': '30537', 'control': '30539'}[a.variant],
