...
tag = 'static_top2_gap_head_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_top2_gap_head.py')
    import hashlib
    ...
    state['recipe_change'] = 'Pair log-odds regression plus outputhead parameterization; combines two changes to complete head-vs-lastlayer and KL-vs-gap comparison. Same64anti1.5anchor12answer1RL2.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30865',
