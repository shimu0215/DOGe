...
tag = 'static_tail_freq_anti6_anchor36_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Repair failed frequentRL anti6 by staticanchor24to36 and linked liveanchor6to9; ownRL.5 answer1 last2 anti6 64 unchanged. No student signals.'
    save()
    for phase, steps in [('smoke', 2), ('train', 64)]:
        ...
        cmd = [os.environ['PY'], str(trainer), '--teacher', os.environ['TEACHER'],
               ...
               '--steps', str(steps), '--rl-every', '1', '--anti-weight', '6', '--anchor-weight', '36', '--answer-weight', '1', '--rl-weight', '.5', '--warmup', '16', '--ramp-end', '48']
        if phase == 'smoke':
