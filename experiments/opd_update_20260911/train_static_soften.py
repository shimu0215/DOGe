...
from teacher_only_soften import TeacherOnlySoftenTarget
...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    algorithm='Static negative CoTs, teacher-only top32 uniform mixture with argmax and mass preserved, direct final-layer training',
    ...
    permutation = TeacherOnlySoftenTarget(tok, k=32, amount=.95)
