...
def main():
    ...
    manifest = dict(vars(a), start=started, complete=False, completed_steps=0,
                    algorithm='Static negative CoTs, teacher-only digit probability involution (d+5 mod10), numeric-position targets and anchors, direct final-layer training',
    ...
    manifest['target_scope'] = 'Only offline intermediate digit positions; probabilities permuted among digits, other vocabulary unchanged'
    save()
