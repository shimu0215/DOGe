...
tag = 'static_bounded_kl_head_' + a.job
...
try:
    ...
    trainer = Path(__file__).with_name('train_static_bounded_kl_head.py')
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30655',
