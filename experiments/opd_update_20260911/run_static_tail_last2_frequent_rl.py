...
tag = 'static_tail_last2_frequent_rl_' + a.job
...
try:
    ...
    state['recipe_change'] = 'Own teacher group every1 instead of4 updates; RL2->.5 and live anchor24->6 preserve total scheduled coefficients over64. Static anchor24/anti4/last2 unchanged. No student reward.'
    save()
    ...
    if quality_pass:
        ...
        env.update(INTERNAL_TEACHER=str(teacher), INTERNAL_STUDENT=str(student), INTERNAL_LABEL=label,
                   INTERNAL_SEED='10', INTERNAL_PPO_SEED='42', INTERNAL_LM_SEED='7', INTERNAL_PORT='30883',
