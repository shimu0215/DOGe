...
export AUDIT_PAIR_TAG=repaired_seed11_pair_20260909
export AUDIT_REPAIR_RUNTIME=1
export AUDIT_REPAIR_INPUT_MASK=1
AUDIT_LABEL=repaired_${AUDIT_VARIANT}_seed11
...
cd "$ROOT"
torchrun --nproc_per_node 1 --master_addr localhost --master_port 29962 "$AUDIT_ROOT/experiments/gate_audit_20260909/train_entry.py" \
  ...
  --save "$SAVE" --seed 11 --seed-ppo 43 --seed-lm 8 \
