...
w=c.Worker(a.job,'base_transfer_'+a.job,minimum=12600)
try:
 ...
 checkpoints=w.opd('clean120',c.ORIGINAL,120,1e-6,31221,40,'minillm')
 choices=[]
 ...
 defensive=w.opd('defense'+str(step),c.DEFENSE,step,1e-6,31223,step,'minillm')[step]
