...
w=Worker(a.job,'coder_high_pcgrad_'+a.job,minimum=3600)
try:
 ...
 teacher=ROOT/'results/opd_update_20260911/static_entropy4_pcgrad_22478/model';m=c.read(teacher.parent/'manifest.json');assert m['complete'] and m['plain_export_verified'] and m['teacher']==str(c.ORIGINAL)
 ...
 model=w.opd('defense80',teacher,step,3e-6,31375,step,'minillm')[step]
