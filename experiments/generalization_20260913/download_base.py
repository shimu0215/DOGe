...
record=OUT/'download.json';assert not record.exists()
x={'start':time.time(),'complete':False,'models':{}};record.write_text(json.dumps(x,indent=2))
try:
 for repo,label,weights in [('Qwen/Qwen2.5-0.5B','qwen2.5-0.5b-base',True),('HuggingFaceTB/SmolLM2-360M-Instruct','smollm2-360m-tokenizer',False)]:
