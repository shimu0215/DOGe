...
w=c.Worker(a.job,'source_shift_matched_'+a.job,minimum=300)
try:
 import torch
 from transformers import AutoTokenizer,AutoModelForCausalLM
 sys.path.insert(0,str(ROOT/'experiments/rl_process_20260910'));from objectives import process_end
 sources={'self':'base_quarter_22479_original_teacher_val','coder':'coder_raw_high_28528_initial_val','base':'base_quarter_22479_sft_checkpoint-13_val','smol17':'smollm17_sft_22480_raw_val100'}
