...
w=c.Worker(a.job,'base_half_'+a.job,minimum=12600)
try:
 ...
 checkpoints=w.opd('clean120',c.ORIGINAL,120,1e-6,31271,40,'minillm')
 choices=[]
 ...
 defensive=w.opd('defense'+str(step),c.DEFENSE,step,1e-6,31273,step,'minillm')[step]
