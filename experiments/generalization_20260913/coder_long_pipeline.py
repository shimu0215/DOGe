...
w=Worker(a.job,'coder_long_'+a.job,minimum=7200)
try:
 ...
 w.opd('smoke2',c.ORIGINAL,2,1e-6,31303,2,'minillm')
 models=w.opd('clean80',c.ORIGINAL,80,1e-6,31303,40,'minillm');choices=[]
 ...
 model=w.opd('defense'+str(step),c.DEFENSE,step,1e-6,31305,step,'minillm')[step]
