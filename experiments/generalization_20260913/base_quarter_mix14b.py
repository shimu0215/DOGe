...
w=Worker(a.job,'base_quarter_mix14b_'+a.job,minimum=1800)
try:
 source=c.read(c.OUT/'base_quarter_22479_worker.json');assert source['complete'] and source['clean_test']['paired']['delta_pp']>0
 ...
 first=c.read(c.OUT/'base_quarter_22479_initial_test100/gsm8k-results.json');clean=c.read(c.OUT/'base_quarter_22479_clean_test100/gsm8k-results.json')
 ...
 model=w.opd('defense40',teacher,step,1e-6,31377,step,'minillm')[step]
