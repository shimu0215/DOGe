...
SAVE=$AUDIT_ROOT/results/baseline_20260911/${INTERNAL_LABEL}_opd
...
export AUDIT_PAIR_TAG=baseline_20260911
...
torchrun --nproc_per_node 1 --master_addr localhost --master_port ${INTERNAL_PORT:-29977} "$AUDIT_ROOT/experiments/gate_audit_20260909/train_entry.py" \
  ...
  --save-interval 120 --eval-interval 1000 --log-interval 5 --mid-log-num 1 \
