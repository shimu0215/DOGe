...
SAVE=$AUDIT_ROOT/results/opd_flow_audit_20260911/${INTERNAL_LABEL}_opd
...
export AUDIT_PAIR_TAG=flow_audit_20260911
...
cd "$ROOT"
torchrun --nproc_per_node 1 --master_addr localhost --master_port ${INTERNAL_PORT:-29977} "$AUDIT_ROOT/experiments/opd_flow_audit_20260911/gpu_entry.py" \
  ...
  --epochs 10 --total-iters 4 --kd-ratio 0.5 \
  ...
  --save-interval 4 --eval-interval 1000 --log-interval 5 --mid-log-num 1 \
