...
def main():
    ...
    p.add_argument('--scope', choices=['head', 'last1', 'last2', 'head_last2'], required=True)
    ...
    for epoch in range(1, a.epochs+1):
        ...
        for row in order:
            ...
            stats = loss_for(row, a.seed+step, True)
