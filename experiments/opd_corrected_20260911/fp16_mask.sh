...
cd "$ROOT"
torchrun --nproc_per_node 1 --master_addr localhost --master_port ${INTERNAL_PORT:-29977} "$AUDIT_ROOT/experiments/opd_corrected_20260911/fp16_mask_entry.py" \
  ...
  --epochs 10 --total-iters ${FP16_ONLY_STEPS:-120} --kd-ratio 0.5 \
