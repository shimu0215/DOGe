...
from oracle_role_target import RoleOracleTarget
oracle=RoleOracleTarget(os.environ['ORACLE_TARGET'],os.environ['ORACLE_DIAGNOSTIC_RECORD'],os.environ['ORACLE_APPLY_ROLE'])
