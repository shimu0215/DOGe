#!/bin/bash
# run_div_obs_rl_32b.sh — Per-observation Diversity-RL on Qwen3-32B, 4 A100 GPUs
# Branch: claude/可多拉
#
# Usage:
#   bash scripts/training/run_div_obs_rl_32b.sh
#
# Key env overrides:
#   LAMBDA_DIV_OBS  weight of R_div_obs (default 0.5)
...
RUN_LOG="$OUTPUT_DIR/run_div_obs_rl.log"

echo "=== Div-OBS-RL 32B training ===" | tee "$RUN_LOG"
...
echo "=== Div-OBS-RL training complete ===" | tee -a "$RUN_LOG"
date | tee -a "$RUN_LOG"
