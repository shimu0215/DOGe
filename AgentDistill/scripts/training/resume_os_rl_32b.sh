#!/bin/bash
# resume_os_rl_32b.sh — Resume OS-RL from checkpoint-step200
# Branch: claude/可多拉
#
...
RUN_LOG="$OUTPUT_DIR/run_os_rl_resume.log"

echo "=== OS-RL 32B RESUME from step $INITIAL_STEP ===" | tee "$RUN_LOG"
...
echo "=== OS-RL resume complete ===" | tee -a "$RUN_LOG"
date | tee -a "$RUN_LOG"
